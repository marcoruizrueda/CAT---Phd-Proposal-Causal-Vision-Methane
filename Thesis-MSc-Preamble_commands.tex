...
\usepackage{chemgreek}          % needed for chemmacros compatibility
\usepackage{chemmacros}
\chemsetup{greek=upgreek}       % tell chemmacros to use upgreek mapping
...
\input{./Chapters/Thesis-MSc-Glossary.tex}
% #############################################################################
...
\usepackage{ragged2e}  % For \RaggedRight to allow better text wrapping without overfull hboxes
